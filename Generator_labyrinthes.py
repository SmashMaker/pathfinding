#############################################################
# Code from TheAypisamFPV
# Profile: https://github.com/TheAypisamFpv
# Repository: https://github.com/TheAypisamFpv/maze_generator
#
...
class Maze_recursive_backtracking:
    def __init__(self, width: int, height: int, make_it_complex : bool,visualize: bool):
        self.width = width
        self.height = height
        self.maze_grid = [[Cell_recursive_backtracking(x, y) for y in range(self.height)] for x in range(self.width)]
        self.stack = []
        self.make_it_complex = make_it_complex
...
def create_maze(width=WIDTH, height=HEIGHT, make_complex=True, visualize=VISUALIZE):
    ...
    """
    maze = Maze_recursive_backtracking(int(width/2), int(height/2), make_complex,visualize)
